function function_Greenspan_PLOTS_mles_with_different_ics_164
...
simulation_id = 'Sim164Data1250MLE1250';
...
simulation_id = 'Sim164Data1250MLE2500';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data1250MLE5000';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data1250MLE10000';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data2500MLE1250';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data2500MLE2500';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data2500MLE5000';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data2500MLE10000';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data5000MLE1250';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data5000MLE2500';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data5000MLE5000';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data5000MLE10000';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data10000MLE1250';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data10000MLE2500';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data10000MLE5000';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
...
simulation_id = 'Sim164Data10000MLE10000';
folder_name = [simulation_id ];
if ~exist([folder_name'], 'dir')
    mkdir([folder_name]);
end
