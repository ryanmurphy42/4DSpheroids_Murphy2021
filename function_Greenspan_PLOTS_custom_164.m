function function_Greenspan_PLOTS_custom_v4_164
...
%% FigCustom_Fig4_164 - Fig 4 - 1250 v 2500 v 5000 v 10000
...
for parameters_to_profile_this_loop = 1:5
    ...
    plot_counter=0;
    figure
    for simulation_num=[1641101,1642101,1643101,1644101]
    ...
    %% Save Figure
    print(gcf,'-depsc2',[filepath_save_custom_plots  'FigCustom_Fig4_164_' num2str(parameters_to_profile_this_loop) '_Profile_likelihood' '.eps']);
    saveas(gcf, [filepath_save_custom_plots 'FigCustom_164_' num2str(parameters_to_profile_this_loop) '_Profile_likelihood'  '.fig'])
    saveas(gcf, [filepath_save_custom_plots 'FigCustom_164_' num2str(parameters_to_profile_this_loop) '_Profile_likelihood' '.jpg'])
    saveas(gcf, [filepath_save_custom_plots 'FigCustom_164_' num2str(parameters_to_profile_this_loop) '_Profile_likelihood' '.pdf'])
